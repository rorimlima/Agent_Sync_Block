...
import { ClipboardList, Search, Filter, ChevronLeft, ChevronRight, Loader2, User, Shield, Upload, ShoppingCart, AlertTriangle, Lock, KeyRound, LogIn, LogOut as LogOutIcon, X } from 'lucide-react';
...
const ACAO_CONFIG = {
  ...
  INADIMPLENCIA:{ icon: AlertTriangle,   color: 'text-danger',   bg: 'bg-danger/10',  label: 'Inadimplência' },
};
